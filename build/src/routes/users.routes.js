...
usersRoutes.get('/', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, listUsersController.handle);
const findUserByIDController = new FindUserByIDController_1.FindUserByIDController();
usersRoutes.get('/findByID/:id', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, findUserByIDController.handle);
...
usersRoutes.post('/create', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, createUsersController.handle);
const updateUsersController = new UpdateUsersController_1.UpdateUsersController();
usersRoutes.put('/update/:id', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, updateUsersController.handle);
const deleteUsersController = new DeleteUsersController_1.DeleteUsersController();
usersRoutes.delete('/delete', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, deleteUsersController.handle);
const listResumedUsersController = new ListResumedUsersController_1.ListResumedUsersController();
usersRoutes.get('/resume', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, listResumedUsersController.handle);
const resetPasswordUsersController = new ResetPasswordUsersController_1.ResetPasswordUsersController();
usersRoutes.post('/reset-password', auth0Check_1.checkJwtFromCookie, auth0Check_1.jwtCheck, resetPasswordUsersController.handle);
