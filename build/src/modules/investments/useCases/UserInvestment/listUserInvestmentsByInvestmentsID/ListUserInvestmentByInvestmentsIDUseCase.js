...
exports.ListUserInvestmentByInvestmentsIDUseCase = void 0;
    ...
    execute(listUserInvestmentData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield this.userInvestmentRepository.filterUserInvestmentByInvestmentID(listUserInvestmentFormatted);
                return response;
            }
            catch (error) {
                throw error;
...
exports.ListUserInvestmentByInvestmentsIDUseCase = ListUserInvestmentByInvestmentsIDUseCase;
