...
const ListUserInvestmentsSchema_1 = require("./ListUserInvestmentsSchema");
function checkQuery(listUserInvestmentData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield ListUserInvestmentsSchema_1.listUserInvestmentSchema.validate(listUserInvestmentData, {
                abortEarly: false
            });
        }
        catch (error) {
