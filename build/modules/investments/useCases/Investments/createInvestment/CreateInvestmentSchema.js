...
const createInvestmentSchema = yup.object({
    ...
    description: yup.string().required("A descrição do investimento é obrigatório."),
    ...
    finishDate: yup.date().required("A data da entrega é obrigatória"),
    buildingStatus: yup.string().required("O status é obrigatório"),
